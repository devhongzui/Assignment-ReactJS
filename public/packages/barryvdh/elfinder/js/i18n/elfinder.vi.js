...
(function (root, factory) {
    ...
    elFinder.prototype.i18.vi = {
        translator:
            "Chung Thủy f &lt;chungthuyf@gmail.com&gt;, Son Nguyen &lt;son.nguyen@catalyst.net.nz&gt;, Nguyễn Trần Chung &lt;admin@chungnguyen.xyz&gt;",
        ...
        messages: {
            ...
            errNotReplace:
                'Đối tượng "$1" đã tồn tại ở vị trí này và không thể thay thế bằng đối tượng với loại khác.', // new
            ...
            errArcSymlinks:
                "Vì lý do bảo mật, từ chối giải nén tập tin lưu trữ có chứa liên kết mềm.", // edited 24.06.2012
            errArcMaxSize:
                "Tập tin lưu trữ vượt quá kích thước tối đa cho phép.",
            ...
            errNotUTF8Content:
                'Tệp "$1" không phải bộ ký tự UTF-8 nên không thể chỉnh sửa.', // added 9.11.2011
            ...
            errFolderUpload:
                "Hãy thử trình duyệt mới hơn (vì trình duyệt hiện tại có vẻ cũ nên không hỗ trợ  tải lên thư mục).", // from v2.1 added 26.6.2015
            errSearchTimeout:
                'Đã hết thời gian trong khi tìm kiếm "$1". Kết quả tìm kiếm là một phần.', // from v2.1 added 12.1.2016
            ...
            errRestore:
                "Không thể khôi phục từ thùng rác. Không thể xác định đích khôi phục.", // from v2.1.24 added 3.5.2017
            errEditorNotFound:
                "Không tìm thấy trình chỉnh sửa cho loại tệp này.", // from v2.1.25 added 23.5.2017
            ...
            confirmRm:
                "Bạn có chắc chắn muốn xóa vĩnh viễn các mục?<br/>  Điều này không thể được hoàn tác!",
            confirmRepl:
                "Thay tập tin cũ bằng tập tin mới? (Nếu nó chứa các thư mục, nó sẽ được hợp nhất. Để sao lưu và thay thế, chọn Sao lưu.)",
            ...
            emptyLetSearch:
                "Kết quả tìm kiếm thư đầu tiên là trống trong chế độ xem hiện tại.", // from v2.1.23 added 24.3.2017
            ...
            tooManyToTrash:
                "Có quá nhiều mục vì vậy không thể cho vào thùng rác.", // from v2.1.25 added 9.6.2017
